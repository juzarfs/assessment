...
public class AccountCollectionResourceTest {

	@InjectMocks
	AccountCollectionResource accountCollectionResource;
	...
	public void testGetAccounts() {
		...
		Response result = accountCollectionResource.getAccounts();
		List<Account> entity = (List<Account>) result.getEntity(); 
	...
	public void testGetAccountResource(){
		...
		when(resourceContext.getResource(AccountResource.class)).thenReturn(accountResource);
		AccountResource result = accountCollectionResource.getAccountResource(123l);
		assertEquals(result,accountResource);
	}
}
